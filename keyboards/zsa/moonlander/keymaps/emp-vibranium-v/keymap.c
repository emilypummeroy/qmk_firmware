...
enum custom_keycodes {
  ...
  AD_MACRO_NGTH, // Strength
  AD_MACRO_PHTH, // Diphthong
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_moonlander(
    ...
    KC_GRAVE,       LT(0, KC_X),    KC_W,           KC_M,           KC_G,           KC_F,           KC_DELETE,                                      KC_INSERT,      KC_SCLN,        KC_DOT,         KC_QUOTE,       KC_J,           KC_AT,          XXXXXXX,
  ...
  [_LMOD] = LAYOUT_moonlander(
    ...
    _______,        XXXXXXX,        KC_LCBR,        KC_RCBR,        ST_FORCE_EQUAL, XXXXXXX,                                                                        _______,        _______,        _______,        _______,        _______,        _______,
  ...
  [_NUM] = LAYOUT_moonlander(
    ...
    _______,        XXXXXXX,        KC_LBRC,        KC_RBRC,        KC_EQUAL,       XXXXXXX,                                                                        KC_MINUS,       KC_1,           KC_2,           KC_3,           _______,        _______,
  ...
  [_NUMPAD] = LAYOUT_moonlander(
    ...
    _______,        XXXXXXX,        KC_LBRC,        KC_RBRC,        KC_EQUAL,       XXXXXXX,                                                                        KC_KP_MINUS,    KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_SLASH,    _______,
...
const uint16_t PROGMEM adaptiveMKC[] = { KC_M, KC_K, KC_C, COMBO_END };
...
const uint16_t PROGMEM adaptiveSCNT[] = { KC_S, KC_C, KC_N, KC_T, COMBO_END };
const uint16_t PROGMEM adaptiveWMGF[] = { KC_W, KC_M, KC_G, KC_F, COMBO_END };
...
combo_t key_combos[] = {
  ...
  [AD_VC_XC] = COMBO(adaptiveVC, AD_MACRO_XC),
  ...
  [AD_MKC_WKS] = COMBO(adaptiveMKC, AD_MACRO_WKS),
  ...
  [AD_XWM_XCH] = COMBO(adaptiveXWM, AD_MACRO_XCH), // Exchange
  ...
  [AD_SCNT_NGTH] = COMBO(adaptiveSCNT, AD_MACRO_NGTH), // Strength
  [AD_WMGF_PHTH] = COMBO(adaptiveWMGF, AD_MACRO_PHTH), // Diphthong
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  // H digraph adaptives
    ...
    SEND_CASED_STRINGS(AD_MACRO_NGTH, "ngth", "Ngth", "NGTH"); // Strength
    SEND_CASED_STRINGS(AD_MACRO_PHTH, "phth", "Phth", "PHTH"); // Diphthong
